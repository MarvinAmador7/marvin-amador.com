  ...
  return (
    <article className="border-b border-line [animation:reveal_600ms_both] [&:nth-child(2)]:[animation-delay:70ms] [&:nth-child(3)]:[animation-delay:140ms]">
      <Link
        ...
        className="group grid grid-cols-[58px_minmax(0,1fr)_24px] gap-6 min-h-[200px] py-[30px] transition-[background-color,padding] duration-[180ms] hover:bg-surface hover:px-[14px] max-[640px]:grid-cols-[30px_minmax(0,1fr)_18px] max-[640px]:gap-3 max-[640px]:min-h-0 max-[640px]:py-[26px] max-[640px]:hover:px-0"
      >
